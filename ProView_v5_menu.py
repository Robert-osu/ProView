    ...
    def run(self):
        ...
        while running:
            ...
            for event in pygame.event.get():
                # Сначала обрабатываем Ctrl+C в самом начале
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_c and (pygame.key.get_mods() & pygame.KMOD_CTRL):
                        print("!!! Ctrl+C перехвачен в начале обработки !!!")
...
if __name__ == "__main__":
    ...
    if not image_files:
        ...
        viewer = ProgrammatorViewer(image_files, pro.getCommands(), k_size=v_k[1])
        viewer.run()
